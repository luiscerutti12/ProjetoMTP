...
public class Logar extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        boolean T = new Conexao().Consultar(jTextField1.getText() , new String(jPasswordField1.getPassword()));
        if (T==true) {
            JOptionPane.showMessageDialog(null , "Você foi autenticado.");
            this.dispose();
        }
        else {
            JOptionPane.showMessageDialog(null, "Usuário ou senha não conhecidem." , "Erro" , JOptionPane.ERROR_MESSAGE);
        }
